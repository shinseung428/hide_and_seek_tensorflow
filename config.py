...
#Image setting
parser.add_argument('--input_width', dest='input_width', default=160, help='input image width')
parser.add_argument('--input_height', dest='input_height', default=160, help='input image height')
